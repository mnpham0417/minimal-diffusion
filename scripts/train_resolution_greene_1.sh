...
singularity exec --nv \
  ...
  /bin/bash -c 'source /ext3/env.sh; conda activate /scratch/mp5847/conda_environments/conda_pkgs/diffusion_ft; cd /vast/mp5847/minimal-diffusion/; \
        ...
        --dataset mnist \
        --arch UNet_8 \
        --pretrained-ckpt /vast/mp5847/minimal-diffusion/trained_models_UNet_8_unit_sphere_ft_0_lr=0.0001_epochs=100_resteer=0_to_1/UNet_8_mnist-epoch_100-timesteps_1000-class_condn_True_ema_0.9995.pt \
        --target-class 0 \
        --output-file-name "resolution_mnist_0_UNet_8_unit_sphere_ft_0_lr=0.0001_epochs=100_resteer=0_to_1_clower=1_cupper=5_rslower=1_rsupper=3_nimages=10.txt" \
        --complexity-lower 1 \
        --complexity-upper 5 \
        --random-seed-lower 1 \
        --random-seed-upper 3 \
