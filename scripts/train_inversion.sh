...
CUDA_VISIBLE_DEVICES=0,1 python -m torch.distributed.launch --nproc_per_node=2 --master_port 8103 main_inversion.py --arch UNet --dataset mnist --epochs 500 --batch-size 1024 --sampling-steps 200 --save-dir ./test/ --target-class 0 --lr 0.01 \
        --pretrained-ckpt "/vast/mp5847/minimal-diffusion/trained_models_UNet/UNet_mnist-epoch_100-timesteps_1000-class_condn_True_ema_0.9995.pt" --class-cond

# CUDA_VISIBLE_DEVICES=0 python3 main_inversion.py --arch UNet_4 --dataset mnist --epochs 100 --batch-size 512 --sampling-steps 200 --save-dir ./trained_models_UNet_4_unit_sphere_ft_0_lr=0.0001_epochs=100_inversion/ --target-class 0 --lr 0.0001 \
#         --pretrained-ckpt "/vast/mp5847/minimal-diffusion/trained_models_UNet_4_unit_sphere/UNet_4_mnist-epoch_100-timesteps_1000-class_condn_True_ema_0.9995.pt" --class-cond
